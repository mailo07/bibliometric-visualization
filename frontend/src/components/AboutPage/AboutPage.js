        ...
        <div>
            ...
            <header className="header">
                ...
                <div className="main-content">
                    ...
                    <button className="cta" onClick={openSignupDialog}>SIGN IN</button>
                </div>
            </header>
            ...
            {isSignupDialogOpen && (
                <div>
                    <div className="signup-dialog">
                        <button onClick={closeSignupDialog} style={{ position: 'absolute', top: '10px', right: '10px' }}>X</button>
                        <h2>Sign in to Biblioknow</h2>
                        <form>
                    ...
                    <div className="dialog-overlay" onClick={closeSignupDialog}></div>
                </div>
            )}
            ...
            <div className="flex flex-col md:flex-row min-h-screen">
                <div className="md:w-1/2 p-10">
                    <div className="typewriter mt-16">
                        <h1 className="text-5xl font-bold mb-8">Welcome to Biblioknow</h1><br/>
                        <p className="text-lg mb-8">
                            Our promise to you when using this website, we will always provide the best we have at no cost, to be used and shared by anyone with absolute peace of mind no one is watching.
                        </p>
                    </div>
                ...
                <div className="md:w-1/2 p-10">
                    <img
                        src="https://images.pexels.com/photos/11858826/pexels-photo-11858826.jpeg"
                        alt="Bookshelves filled with books in a library"
            ...
            <div className="flex flex-col min-h-screen">
                <header className="bg-[#f0f0f0] text-[#4a3b2b] font-bold p-4 overflow-hidden relative">
                    ...
                    <div className="flex justify-center items-center">
                        <span className="scrolling-text text-7xl">Bibliometric data Analysis and Visualization</span>
                    </div>
                ...
                <main className="flex justify-center items-center flex-grow p-8">
                    <div className="text-center mr-8">
                        <p className="text-lg">Discover, Analyse, and Map Global Innovation Knowledge</p>
                    </div>
                    <div>
                        <video id="autoplayVideo" className="w-[600px] h-auto" muted loop autoPlay>
                            <source src="https://videos.pexels.com/video-files/6980539/6980539-uhd_2560_1440_25fps.mp4" type="video/mp4" />
...
function AccordionItem({ title, content, isOpen, onClick }) {
    return (
        <div className="border-t border-gray-400 py-4">
            ...
            <div className={`accordion-content ${isOpen ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0'}`}>
